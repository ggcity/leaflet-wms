...
import { Layer } from '../../leaflet/src/layer/Layer.js';
import { ImageOverlay } from '../../leaflet/src/layer/ImageOverlay.js';
import { TileLayerWMS, tileLayerWMS } from '../../leaflet/src/layer/tile/TileLayer.WMS.js';
...
wms.Overlay = Layer.extend({
    ...
    'update': function() {
        ...
        var overlay = new ImageOverlay(url, bounds, {'opacity': 0});
